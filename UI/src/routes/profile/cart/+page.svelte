...
<div class="col-span-9 space-y-4">
	<div class="flex items-center bg-gray-500 justify-between border gap-6 p-4 border-gray-200">
		...
		<div class="text-white text-lg font-semibold">$320.00</div>

		<div class="w-1/4 cursor-pointer hover:text-primary">
			<i class="fa-solid fa-trash"></i>
		</div>
		<a href=""
			class=" px-6 py-2 text-center text-sm text-white bg-green-600 hover:bg-green-400 border border-green-400 rounded transition uppercase font-roboto font-medium">Save</a>
		<a href="/checkout"
			class=" px-6 py-2 text-center text-sm text-white bg-blue-600 hover:bg-blue-400 border border-green-400 rounded transition uppercase font-roboto font-medium">Check out</a>
	</div>
